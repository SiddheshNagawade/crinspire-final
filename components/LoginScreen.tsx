        ...
        if (authMode === 'REGISTER') {
            ...
            if (signUpError) {
                ...
                if (data && data.user) {
                    ...
                    const name = data.user.user_metadata.full_name || sName || 'Student';
                    const age = data.user.user_metadata.age || sAge || '';
                    ...
                    {showForgotPasswordForm ? (
                        ...
                        <div className="space-y-4">
                            ...
                            <button
                                ...
                                disabled={loading}
                                className="w-full bg-white border border-[#D1D5DB] text-[#1F2937] font-bold py-3.5 rounded-lg hover:bg-[#F9FAFB] transition-all shadow-sm active:transform active:scale-[0.98] flex items-center justify-center disabled:opacity-50"
                            >
                            ...
                            <div className="relative flex items-center justify-center my-6">
                                <div className="border-t border-[#E5E7EB] w-full absolute"></div>
                                <span className="bg-white px-3 text-xs font-bold text-[#9CA3AF] relative z-10 uppercase tracking-wider">Or continue with email</span>
                            </div>
